...
//   make email, password, repassword Textfield
    ...
    UIView *lineView2 = [[UIView alloc] initWithFrame:CGRectMake(VIEW_MARGIN*3, offsetY-7*screenWidth/375, self.emailField.frame.size.width, 1)];
    ...
    UIView *lineView3 = [[UIView alloc] initWithFrame:CGRectMake(VIEW_MARGIN*3, offsetY-7*screenWidth/375, self.emailField.frame.size.width, 1)];
