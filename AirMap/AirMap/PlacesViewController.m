...
- (void)textFieldDidBeginEditing:(UITextField *)textField {
    ...
    self.resultTableViewController.view.frame = CGRectMake(10.0f, self.backButton.bounds.size.height + self.backButton.bounds.origin.y, self.view.bounds.size.width - (10.f * 2), self.view.bounds.size.height - 44.0f);
